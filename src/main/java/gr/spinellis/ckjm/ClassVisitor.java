...
public class ClassVisitor extends org.apache.bcel.classfile.EmptyVisitor {
    ...
    void registerMethodInvocation(String signature, String className) {
        registerCoupling(className);
    ...
    public void visitMethod(Method method) {
        ...
        incRFC(getMyClassName() + "." + mg.getName() + mg.getSignature());
     ...
     */
    public void end() {
        if (mProp.isMergeLambdaAccessIntoMethods()) {
            LambdaUtils.removeLambdas(mFieldsUsedByMethods, mMethodsUsedByMethods, mClassMetrics, mResponseSet, getMyClassName());
        }
